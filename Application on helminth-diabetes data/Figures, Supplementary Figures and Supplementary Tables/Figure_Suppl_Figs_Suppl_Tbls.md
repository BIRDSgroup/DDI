...
Run the ["Heatmaps_Script.R"]() under the [**Scripts**]() section. Refer to the [Readme]() file on how to run this script. This will generate **heatmap_fig2a.png** in the folder set as the working directory. 
